    ...
    public class Rad2022Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Members>().HasData(
                new Members { MemberID = 1, Name = "Elizabeth Anderson", Address = "8 Johnston Road, Dublin", Phone = "(01)-12345322", ShareBalance = 200.00m },
                new Members { MemberID = 2, Name = "Catherine Autier Miconi", Address = "Garden House Crowther Way, Dublin 20", Phone = "(01)-62634562", ShareBalance = 400.00m },
                new Members { MemberID = 3, Name = "Thomas Axen", Address = "1900 Oak St., Dublin 4", Phone = "(01)-89377483", ShareBalance = 2000.00m },
                new Members { MemberID = 4, Name = "John B. Aird", Address = "8 Johnston Road, Dublin", Phone = "(01)-12345322", ShareBalance = 800.00m },
                new Members { MemberID = 5, Name = "Elizabeth Anderson", Address = "8 Johnston Road, Dublin", Phone = "(01)-12345322", ShareBalance = 600.00m },
                new Members { MemberID = 6, Name = "Elizabeth Anderson", Address = "8 Johnston Road, Dublin", Phone = "(01)-12345322", ShareBalance = 3000.00m },
                new Members { MemberID = 7, Name = "Elizabeth Anderson", Address = "8 Johnston Road, Dublin", Phone = "(01)-12345322", ShareBalance = 5000.00m }
                );
